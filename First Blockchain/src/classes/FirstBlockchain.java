...
public class FirstBlockchain {
	...
	public static int difficulty = 5; //static difficulty for block mining testing
	public static Wallet walletA;
	public static Wallet walletB;
	public static Transaction genesisTransaction;
	
	/* function to check block chain integrity.
	 * Any change to the blocks in the chain will 
	...
	public static Boolean isChainValid() {
		...
		HashMap<String,TransactionOutput> tempUTXOs = new HashMap<String,TransactionOutput>(); //a temp working list of unspent transactions at a given block state
		tempUTXOs.put(genesisTransaction.outputs.get(0).id, genesisTransaction.outputs.get(0));
		
		//Loop through blocks and compare hashes
		for(int i=1; i < blockchain.size(); i++) {
			...
			//Loop through the blockchain transactions
	...
	public static void main(String[] args) {
		...
		UTXOs.put(genesisTransaction.outputs.get(0).id, genesisTransaction.outputs.get(0)); //its important to store the first transaction in the UTXOs list
